function [Averaged_Images tform] = zProj3(fileName, ImagesPerSlice, ImageSize, StepCount, FlyBackFrames)
...
for Slice = 1:StepCount
	...
	if(sum(zScore > 2))
		disp(['Mean-squared error suggests incorrect registeration in slice ' int2str(Slice) '. It'' possbile there''s z-drift.']);
	end 
